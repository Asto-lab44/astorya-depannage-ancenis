...
(function () {
  ...
  if (path.includes('depannage') || path.includes('infogerance') || path.includes('maintenance')) {
    ...
    initialMessage = "Bonjour 👋 Une question sur la téléphonie cloud ou la fibre pro à Ancenis ?";
    ...
    initialMessage = "Bonjour 👋 Bienvenue chez Astorya, votre informatique à Ancenis. Comment pouvons-nous vous aider ?";
  }
